...
{
	/// <summary>
	/// The palette abgr 1555 + 4 bits per index.
	/// </summary>
	public class Palette4Abgr1555 : ImageFormat, IImageFormat
	{
		#region Constructors and Destructors

		/// <summary>
		/// Initializes a new instance of the <see cref="Palette4Abgr1555"/> class.
		/// </summary>
		/// <param name="width">
		/// The width.
		/// </param>
		...
		/// The pitch.
		/// </param>
		public Palette4Abgr1555(int width, int height, int pitch)
		...
		public void ReadData(Stream stream)
		{
			...
			this.ReadPaletteARGB1555(stream, 16);
